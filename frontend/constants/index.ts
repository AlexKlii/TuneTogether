...
export const uscdContractAddress = `${process.env.NEXT_PUBLIC_USDC_CONTRACT_ADDRESS}` as `0x${string}`
        ...
        "outputs": [
            {
                ...
                "internalType": "struct TuneTogether.Artist",
                "name": "_artist",
                "type": "tuple"
            }
        ],
        ...
        "outputs": [
            {
                ...
                "internalType": "struct TuneTogether.Campaign",
                "name": "_campaign",
                "type": "tuple"
            }
        ],
